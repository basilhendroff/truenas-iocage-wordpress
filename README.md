...
If you need to set up a reverse proxy, there are at least two resources available, that you might want to consider, in the resources section of the FreeNAS forum:
